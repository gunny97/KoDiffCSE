...
def cl_init(cls, config):
    ...
    cls.generator = transformers.AutoModelForMaskedLM.from_pretrained(cls.model_args.generator_name)
    cls.electra_acc = 0.0
