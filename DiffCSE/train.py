...
def main():
    ...
    if model_args.tokenizer_name:
        ...
        # tokenizer = KoBertTokenizer.from_pretrained(model_args.tokenizer_name, **tokenizer_kwargs)
    elif model_args.model_name_or_path:
        tokenizer = AutoTokenizer.from_pretrained(model_args.model_name_or_path, **tokenizer_kwargs)
        # tokenizer = KoBertTokenizer.from_pretrained(model_args.model_name_or_path, **tokenizer_kwargs)
    else:
        raise ValueError(
    ...
    if model_args.model_name_or_path:
        if 'roberta' in model_args.model_name_or_path:
            ...
            pretrained_model = AutoModelForMaskedLM.from_pretrained(model_args.model_name_or_path)
